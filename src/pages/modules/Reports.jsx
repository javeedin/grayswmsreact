...
const sections = [
  {
    title: 'KPI Dashboard',
    description: 'Live warehouse KPIs: orders processed, pick accuracy, and throughput.',
  ...
  },
  {
    ...
    description: 'Stock valuation, ageing, and movement reports by date range.',
  ...
  {
    title: 'Order Reports',
    description: 'Order fulfilment rates, on-time delivery, and backorder analysis.',
    icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/><path d="M2 20h20"/></svg>,
  },
  {
    title: 'Productivity Reports',
    description: 'Staff productivity, pick rates, and task completion metrics.',
    icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>,
  },
  {
    title: 'Scheduled Reports',
    description: 'Configure and schedule automatic report delivery via email.',
  ...
  },
  {
    ...
    description: 'Export data to CSV/Excel and view full system audit trails.',
...
export default function Reports() {
  return (
    <ModulePlaceholder
      ...
      subtitle="Insights, dashboards, and data exports for warehouse performance"
      icon={icon}
      color="#0e6fa3"
      bg="#e8f4fc"
      sections={sections}
