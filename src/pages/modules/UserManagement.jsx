...
const sections = [
  {
    title: 'Users',
    description: 'Create, edit, and deactivate user accounts in the system.',
  ...
  },
  {
    ...
    description: 'Define roles and assign granular permissions to control system access.',
  ...
  {
    title: 'Teams',
    description: 'Organise users into teams and assign warehouse zones.',
    icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>,
  },
  {
    title: 'Activity Log',
    description: 'Full audit trail of user login history and system actions.',
  ...
  },
  {
    ...
    description: 'Manage password policies, MFA, and session timeouts.',
  ...
  {
    title: 'Notifications',
    description: 'Configure user notification preferences and alert subscriptions.',
...
export default function UserManagement() {
  return (
    <ModulePlaceholder
      ...
      subtitle="Manage users, roles, permissions, and security settings"
      icon={icon}
      color="#c0392b"
      bg="#fdecea"
      sections={sections}
